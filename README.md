...
| 기능 | 설명 |
|------|------|
| **5종 전략** | DualMomentum, VAA-KR, RiskParity, FactorMomentum, MultiStrategy |
...
| **Web 대시보드** | FastAPI 기반 실시간 포트폴리오 현황 (port 8080) |
...
# 백테스트
python run_backtest.py [--strategy all|dual_momentum|vaa|risk_parity]
...
ExecStart=/usr/bin/python3 run_bot.py --mode kis_real --strategy multi
Restart=always
RestartSec=30
